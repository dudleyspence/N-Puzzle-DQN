...
if restart.upper() == "Y":
    if os.path.exists("training_" + str(N) + "_puzzle_" + str(nodes) + "_nodes"):
        os.system("rm -rf " + "training_" + str(N) + "_puzzle_" + str(nodes) + "_nodes")

else:
    if not os.path.exists("training_" + str(N) + "_puzzle_" + str(nodes) + "_nodes"):
